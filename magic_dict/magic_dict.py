...
class Magic_dict(dict):
    ...
    def __call__(self,*args, **kwargs) -> Any:
        ...
        debug_msg = f"""
                        ...
                        {yes_or_no(f'Is {obj} instance of Magic_dict',
                        isinstance(obj,Magic_dict))}
                        """
        logger.debug(debug_msg)
    ...
    def __setitem__(self, key , value) -> None:
        ...
        value = value if head in obj_keys or isinstance(value,Magic_dict) else\
                Magic_dict(value)
    ...
    def __getitem__(self, key: str) -> Any:
        ...
        if head not in self: self[head] = Magic_dict()
        return super().__getitem__(head)
